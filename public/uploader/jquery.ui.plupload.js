			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						'<div class="plupload_logo"><i class="icon-upload-2 fg-white"></i> </div>' +
						'<div class="plupload_header_title">' + _("Upload hình ảnh") + '</div>' +
						'<div class="plupload_header_text">' + _("Thêm file hoặc kéo thả file vào, sau đó nhấn upload") + '</div>' +
						'<div class="plupload_view_switch">' +
							'<input type="radio" id="'+obj.id+'_view_list" name="view_mode_'+obj.id+'" checked="checked" /><label class="plupload_button" for="'+obj.id+'_view_list" data-view="list">' + _('Danh sách') + '</label>' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("Kéo và thả ảnh vào đây") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("Thêm ảnh") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_start">' + _("Bắt đầu upload") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_stop plupload_hidden">'+_("Ngừng Upload") + '</a>&nbsp;' +
						'</div>' +
